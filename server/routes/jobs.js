...
import { createJob, formTeam, formTeamOptimized, listMyJobs, getMyDisputes, listOpenJobs, applyForJob, getJob, assignWorkers, verifyStartOtp, completeJob, startTravel, arrivedAtLocation, acceptJob, raiseDispute, triggerSOS, submitRating } from '../controllers/jobController.js';
...
router.post('/:jobId/rating', requireAuth, submitRating);
