...
import { createIntent, capture, release, refund, listPayments, getWorkerStats } from '../controllers/paymentController.js';
import { requireAuth, requireRole } from '../middleware/auth.js';

const router = Router();

router.get('/worker-stats', requireAuth, getWorkerStats);
